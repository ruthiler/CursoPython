...
<body>
    <div id="todo-site">
        ...
        <div class="box-principal">
            ...
            <form class="form" action="AdicionaAgendamentoServlet">
                <fieldset class="total">
                    
                    <fieldset class="grupo">    
                        <div class="campo">
                            <label>Nome:</label><br>
                            <input name ="nome" size="43px" type="text" required="required" placeholder="Nome Completo"/>
                        </div>
                        <div class="campo">
                            <label>Telefone:</label><br>
                            <input name="telefone" size="11" type="text" maxlength="11" required="required" placeholder="(XX) X XXXX-XXXX"/>
                        </div>
                        <div class="campo">
                            <label>Veiculo:</label><br>
                            <input name="veiculo" type="text" maxlength="25" required="required" placeholder="Veiculo"/>
                        </div>
                        <div class="campo">
